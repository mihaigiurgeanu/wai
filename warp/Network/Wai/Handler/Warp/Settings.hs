...
data Settings = Settings
    ...
    , settingsHTTP2Enabled :: Bool
      ...
      --
      -- Since 3.1.7.
    , settingsFormatLog :: Request -> H.Status -> Maybe Integer -> IO ByteString
    , settingsWriteLog :: ByteString -> IO ()
    }
...
defaultSettings = Settings
    ...
    , settingsFormatLog = \_ _ _ -> return S8.empty
    , settingsWriteLog = \_ -> return ()
    }
